<template>
	<div class="row justify-content-center">
	  <div class="col-md-8">
        ...
        <p>Les données recueillies pour l'inscription au tirage au sort de la billetterie ne seront utilisées que dans le cadre du tirage au sort.</p>
        ...
        <p>Pour toute information, vous pouvez nous contacter sur dpo@breizhcamp.org</p>
    </div>
  </div>
</template>
